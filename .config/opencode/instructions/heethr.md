...
|------|-----------|--------|
| Backend API | `/home/lucas/Work/Heethr/snow-melting_backend` | **Analysed — see Section 11** |
| Admin Dashboard | `/home/lucas/Work/Heethr/snow_melting_dashboard` | **Analysed — see Section 12** |
| Shop Dashboard | `/home/lucas/Work/Heethr/snow_melting_dashboard-shop` | Not yet analysed — React + Vite + TypeScript (package name: `heether_ecommerce`) |
| Mobile App (Flutter) | `/home/lucas/Work/Heethr/snow-melting_mobile` | Not yet analysed — Flutter (pubspec name: `heethr_production`) |
| heether_utils | `/home/lucas/Work/Heethr/heether_utils` | Empty / placeholder directory |
| local-enviroments | `/home/lucas/Work/Heethr/local-enviroments` | Local env overrides only — contains `.env.local.shop` (`VITE_BACKEND=http://localhost:3000`) |

### Backend dev setup
```bash
cd /home/lucas/Work/Heethr/snow-melting_backend
yarn install
...
**Repo:** `/home/lucas/Work/Heethr/snow-melting_backend`
...
**Repo:** `/home/lucas/Work/Heethr/snow_melting_dashboard`
